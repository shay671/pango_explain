...
from pango_explain.pango_alias import get_unrolled_pango_name, load_alias_map, lookup_alias
...
def test_get_unrolled_pango_name_valid(designation, expected, alias_map):
    assert get_unrolled_pango_name(designation, alias_map) == expected
...
def test_get_unrolled_pango_name_invalid(designation, alias_map):
    with pytest.raises(ValueError):
        get_unrolled_pango_name(designation, alias_map)
